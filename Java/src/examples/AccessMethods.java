...
/*
Example explained
1) We created a custom AccessMethods  class with the class keyword.

2) We created the fullThrottle() and speed() methods in the AccessMethods class.

3) The fullThrottle() method and the speed() method will print out some text, when they are called.

4) The speed() method accepts an int parameter called maxSpeed - we will use this in 8).

5) In order to use the AccessMethods  class and its methods, we need to create an object of the AccessMethods  Class.
