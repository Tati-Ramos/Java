...
public class JavaLinkedList {
    public static void main(String[] args) {
        ...
        cars.add("Mazda");
        cars.addFirst("Palio");
        cars.addLast("Renegade");
        System.out.println(cars);


        System.out.println("Primeiro da lista: " +cars.getFirst());

        System.out.println("Último da lista: " +cars.getLast());
...
The LinkedList stores its items in "containers." The list has a link to the first container and each container
 has a link to the next container in the list. To add an element to the list, the element is placed into a new
